#ifndef REDEPETRIESTRUTURA_H
#define REDEPETRIESTRUTURA_H
...
/* ======== Métodos ========== */
        ...
        /** Construtor **/
        RedePetriEstrutura(int nP =1 , int nT = 1):C(1,1),Pre(1,1),Pos(1,1),M(1,1)
		{
			inicializa(nP, nT);
		}
