...
**
** Created: Mon Jan 13 09:30:46 2014
...
static const char qt_meta_stringdata_Server[] = {
    "Server\0\0processNewConnection()\0message\0"
    "processMessage(QString)\0elapsedTime\0"
    "processPong(quint64)\0socketDisconnected()\0"
};
